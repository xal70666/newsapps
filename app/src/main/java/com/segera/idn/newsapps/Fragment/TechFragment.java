...
import com.baihaqi.ubay.newsapps.databinding.FragmentTechBinding;
...
public class TechFragment extends Fragment {
    ...
    private void getData() {
        ...
        GetNewsViewModel vm = new GetNewsViewModel(BASE_URL, "tech");
    ...
    public void fillData() {
        ...
        adapter = new NewsAdapter(modelList, getActivity(), "tech");
