...
import com.baihaqi.ubay.newsapps.databinding.FragmentBussinessBinding;
...
public class BussinessFragment extends Fragment {
    FragmentBussinessBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_bussiness, container, false);
    ...
    private void getData() {
        ...
        GetNewsViewModel vm = new GetNewsViewModel(BASE_URL, "bussiness");
    ...
    public void fillData() {
        ...
        adapter = new NewsAdapter(modelList, getActivity(), "bussiness");
